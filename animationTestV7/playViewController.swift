...
class playViewController: UIViewController {
   ...
   */
    ...
    override func viewDidLoad() {
        ...
        //var timer = NSTimer.scheduledTimerWithTimeInterval(3.0, target: self, selector: "imageAnimations", userInfo: nil, repeats: true)
         ...
         */
         mytimer = NSTimer.scheduledTimerWithTimeInterval(3.0, target: self, selector: #selector(playViewController.imageAnimations), userInfo: nil, repeats: true)
    ...
    */
    ...
    func gameover(){
        ...
        if(counter == 3){
            ...
            saveHighscore(score)
            mytimer?.invalidate()
            performSegueWithIdentifier("segA1", sender: nil)
    ...
    */
    ...
    func playAudio() {                                                                              // this function will be called with the animations
        do {
            if let bundle = NSBundle.mainBundle().pathForResource("beat1", ofType: "mp3") {         // here we are accessing the chosen music file (mp3 format)
    ...
    func imageAnimations(){
        ...
        image1.animationDuration = 0.5      // the duration the animation will last for.
        ...
        delay(1.0){
            ...
            self.image3.animationDuration = 0.5      // the duration the animation will last for.
        ...
        delay(1.5){
            ...
            self.image4.animationDuration = 0.5      // the duration the animation will last for.
